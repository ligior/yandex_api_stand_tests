...
def negative_assert(first_name):
    ...
    # Проверяется, что в ответе поле code содержит 400
    assert user_response.json()["code"] != "400"
    # Проверяется, что в ответе поле message содержит корректное сообщение
...
# Test 2 15 characters positive
def test_create_user_15_letter_in_first_name_get_success_response():
    positive_assert("Абвгдабвгдабвгд")

# Test 3 1 character negative
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert("A")

# Test 4 16 character negative
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert("Абвгдабвгдабвгдв")

# Test 5 eng letters positive
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("Adam")

# Test 6 ru letters positive
def test_create_user_russian_letter_in_first_name_get_success_response():
    positive_assert("Адам")

# Test 7 space in a middle negative
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert("Ad am")

# Test 8 special symbol negative
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert("Ad&am")

# Test 9 number+letters negative
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert("A1dam")
